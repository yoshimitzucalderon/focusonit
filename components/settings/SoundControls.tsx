    ...
    <div className="space-y-4">
      ...
      {notificationsEnabled && (
        <button
          ...
          className="ml-14 text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium transition-colors"
        >
          🔔 Probar notificación
        </button>
      )}
            ...
            <AnimatePresence>
              {isDropdownOpen && (
                <motion.div
                  ...
                  className="absolute z-20 w-full mt-2 bg-white dark:bg-slate-700 border-2 border-gray-200 dark:border-gray-600 rounded-lg shadow-xl overflow-hidden"
                >
